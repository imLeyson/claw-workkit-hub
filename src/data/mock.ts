...
export const mockWorkKits: WorkKit[] = [
  ...
  {
    id: 'wk3', name: '详情页信息结构优化 Work Kit', version: 'v1.1',
    basedOnProjectId: 'p1', basedOnProjectName: '618 高速吹风机竞品评论分析',
    description: '基于用户评论关注热度，重排详情页模块顺序和首屏信息层级。将决策关键信息（静音、恒温、售后）前置，技术参数后移，降低用户决策门槛。',
    scenario: '618/双11大促前详情页改版 · 新品上架详情页设计 · 爆品详情页复盘优化',
    includedRoles: ['design', 'copywriting', 'merchandise'],
    materialStructure: '竞品详情页截图 · 用户评论关注热点排序 · 行业优秀详情页参考',
    sections: [
      { title: '首屏信息结构', role: 'design', content: [{ title: '首屏信息优先级', type: 'list', items: ['第一屏：核心卖点+价格锚点+信任标签', '第二屏：用户证言+真实使用场景', '第三屏：技术参数+对比图表', '第四屏：售后保障+购买引导'] }] },
      { title: '卖点可视化建议', role: 'copywriting', content: [{ title: '文案转可视化', type: 'list', items: ['噪音数据 → 分贝对比图', '护发效果 → Before/After 实拍', '温控安全 → 温度实测 GIF', '售后承诺 → 保障时间线'] }] },
    ],
    createdAt: '2026-05-15', tags: ['详情页', '设计', '转化率', '用户体验'],
    feedback: 'v1.0 按用户评论热度排序后转化率提升 18%。设计团队建议 v1.1 增加竞品详情页横向对比图，已补充。',
    versionHistory: [
      { version: 'v1.0', date: '2026-05-15', changes: '初始模板：详情页模块重排，首屏信息结构。' },
      { version: 'v1.1', date: '2026-05-28', changes: '增加竞品详情页对比图、卖点可视化建议。' },
    ],
    reuseCount: 2, rating: 4.6,
  },
  {
    id: 'wk4', name: '小红书种草文案 Work Kit', version: 'v1.3',
    basedOnProjectId: 'p1', basedOnProjectName: '618 高速吹风机竞品评论分析',
    description: '将用户真实评论和痛点转化为小红书风格的种草文案。覆盖标题钩子、痛点引入、卖点种草、评论区互动和话题标签五个模块。',
    scenario: '小红书日常种草/大促预热 · 新品上市内容矩阵 · 品类教育内容',
    includedRoles: ['copywriting', 'operations'],
    materialStructure: '用户评论高频词 · 竞品种草帖参考 · 品类热搜词 · 品牌人设定位',
    sections: [
      { title: '种草文案结构模板', role: 'copywriting', content: [{ title: '五段式种草结构', type: 'bullet', items: ['标题钩子：痛点提问+身份标签（例：细软发的姐妹谁懂啊）', '痛点共鸣：用具体场景描述引发共情', '产品种草：卖点+使用体验+效果描述', '评论区预埋：常见问题自问自答', '话题标签：品类词+场景词+品牌词组合'] }] },
    ],
    createdAt: '2026-04-10', tags: ['小红书', '种草', '文案', '内容营销'],
    feedback: 'v1.2 优化了评论区互动话术后互动率提升 35%。v1.3 根据品类热搜词更新了标签策略。',
    versionHistory: [
      { version: 'v1.0', date: '2026-04-10', changes: '初始模板：种草文案结构框架' },
      { version: 'v1.1', date: '2026-04-20', changes: '增加不同类型产品（个护/家居/母婴）的场景模板' },
      { version: 'v1.2', date: '2026-05-05', changes: '优化评论区互动话术，增加防杠话术' },
      { version: 'v1.3', date: '2026-05-22', changes: '根据小红书热搜词更新标签策略' },
    ],
    reuseCount: 7, rating: 4.7,
  },
  {
    id: 'wk5', name: '爆品复盘 Work Kit', version: 'v1.0',
    basedOnProjectId: 'p3', basedOnProjectName: 'Q2 母婴用品用户洞察',
    description: '针对已成功的爆品进行全维度复盘，包括用户评价趋势、渠道表现、卖点有效性验证和竞品跟进策略。适合大促后或季度复盘使用。',
    scenario: '大促后爆品复盘 · 季度经营分析 · 选品策略调整',
    includedRoles: ['operations', 'merchandise', 'copywriting'],
    materialStructure: '销售数据摘要 · 用户评价汇总 · 竞品同期表现 · 渠道投放数据',
    sections: [
      { title: '爆品成功要素拆解', role: 'merchandise', content: [{ title: '成功要素矩阵', type: 'matrix', headers: ['要素', '权重', '数据支撑', '可复制性'], rows: [['价格竞争力', '高', '对比同品类价格带', '可复制'], ['差异化卖点', '高', '用户评论高频词', '部分可复制'], ['渠道优势', '中', '各渠道销量占比', '取决于资源'], ['时机节点', '中', '大促节奏匹配', '周期性']] }] },
      { title: '竞品跟进分析', role: 'operations', content: [{ title: '竞品反应', type: 'list', items: ['竞品是否降价跟进', '竞品是否推出类似产品', '竞品广告投放变化', '竞品用户评价变化趋势'] }] },
    ],
    createdAt: '2026-06-01', tags: ['复盘', '爆品', '选品', '策略'],
    feedback: 'v1.0 刚上线，建议下次复盘时增加渠道 ROI 分析维度。',
    versionHistory: [
      { version: 'v1.0', date: '2026-06-01', changes: '初始版本：爆品成功要素拆解+竞品跟进分析框架。' },
    ],
    reuseCount: 1, rating: 4.3,
  },
  {
    id: 'wk6', name: '新品上架全流程 Work Kit', version: 'v1.1',
    basedOnProjectId: 'p2', basedOnProjectName: '618 扫地机器人竞品分析',
    description: '从选品到上架的全流程模板：竞品分析→卖点提炼→详情页规划→推广策略→客服准备。适合新品类或新 SKU 首次上架时使用。',
    scenario: '新品首次上架 · 新品类拓展 · 新品牌入驻平台',
    includedRoles: ['merchandise', 'copywriting', 'design', 'customer_service'],
    materialStructure: '品类市场分析 · 竞品全维度数据 · 供应链信息 · 平台规则文档',
    sections: [
      { title: '品类竞争格局', role: 'merchandise', content: [{ title: '竞争格局分析', type: 'matrix', headers: ['维度', '本品', '竞品A', '竞品B', '差异策略'], rows: [['价格带', '待定', '', '', '卡位中端'], ['核心卖点', '待提炼', '', '', '差异化定位'], ['目标人群', '待定义', '', '', '人群细分']] }] },
      { title: '上架前检查清单', role: 'operations', content: [{ title: '上架前检查', type: 'list', items: ['详情页审核通过', '客服 FAQ 准备就绪', '库存与物流确认', '推广计划排期', '竞品监控启动', '评价积累策略'] }] },
    ],
    createdAt: '2026-03-20', tags: ['新品上架', '全流程', '选品', '上架准备'],
    feedback: 'v1.0 的竞品维度不够全，v1.1 增加了价格带分析和人群细分。建议下版本增加推广预算模板。',
    versionHistory: [
      { version: 'v1.0', date: '2026-03-20', changes: '初始模板：选品→上架全流程框架' },
      { version: 'v1.1', date: '2026-04-15', changes: '增加品类竞争格局矩阵和上架前检查清单' },
    ],
    reuseCount: 4, rating: 4.5,
  },
  {
    id: 'wk7', name: '双11 客服备战 Work Kit', version: 'v1.2',
    basedOnProjectId: 'p1', basedOnProjectName: '618 高速吹风机竞品评论分析',
    description: '大促期间客服团队的标准化备战方案：高频问题预判、话术模板、情绪管理、售后预案和排班建议。确保大促期间客服响应质量不下降。',
    scenario: '双11/618大促客服备战 · 客服团队培训 · 售后流程优化',
    includedRoles: ['customer_service', 'operations'],
    materialStructure: '历史大促客服数据 · 高频问题分类 · 售后数据统计 · 竞品客服话术',
    sections: [
      { title: '大促高频问题预判', role: 'customer_service', content: [{ title: '高频问题分级', type: 'qa', qa: [{ q: '什么时候发货？能指定快递吗？', a: '付款后48小时内发货，默认中通/圆通。加急可联系客服备注顺丰到付。大促期间物流可能延迟1-2天，感谢理解。' }, { q: '收到货不满意能退吗？', a: '支持7天无理由退货，拆封试用不满意也可退。退货运费我们承担。请在订单页申请，24小时内审核。' }, { q: '价格比昨天贵了能补差价吗？', a: '大促期间价格波动属于正常促销调整，无法补差价。建议关注活动预告，在最低价时段下单。' }] }] },
      { title: '售后应急预案', role: 'operations', content: [{ title: '大促售后预案', type: 'bullet', items: ['物流异常：提前准备补偿方案（优惠券/赠品）', '质量投诉：快速升级通道，24小时给出处理方案', '批量差评：启动好评引导机制+主动联系差评用户', '库存超卖：优先老客发货+新客补偿方案', '客服爆线：预备外包客服+智能机器人分流'] }] },
    ],
    createdAt: '2026-05-20', tags: ['双11', '客服', '备战', '售后', '话术'],
    feedback: 'v1.1 的售后预案在实际大促中救急3次。v1.2 增加了智能机器人分流方案，客服压力降低40%。',
    versionHistory: [
      { version: 'v1.0', date: '2026-05-20', changes: '初始模板：大促高频问题+话术模板' },
      { version: 'v1.1', date: '2026-06-05', changes: '增加售后应急预案和排班建议' },
      { version: 'v1.2', date: '2026-06-15', changes: '增加智能机器人分流+客服压力监控指标' },
    ],
    reuseCount: 6, rating: 4.8,
  },
  {
    id: 'wk8', name: '竞品价格策略分析 Work Kit', version: 'v1.0',
    basedOnProjectId: 'p2', basedOnProjectName: '618 扫地机器人竞品分析',
    description: '系统化分析竞品定价策略：日常价格带、大促降价幅度、赠品策略、满减门槛和价格锚点设计。为618/双11定价决策提供数据支撑。',
    scenario: '618/双11前定价决策 · 日常价格体系优化 · 竞品降价跟进策略',
    includedRoles: ['merchandise', 'operations'],
    materialStructure: '竞品价格历史数据 · 促销活动记录 · 赠品成本数据 · 平台满减规则',
    sections: [
      { title: '竞品价格带分析', role: 'merchandise', content: [{ title: '价格带矩阵', type: 'matrix', headers: ['品牌', '日常价', '大促价', '降幅', '赠品价值', '价格锚点'], rows: [['竞品A', '¥499', '¥349', '30%', '¥50', '性价比'], ['竞品B', '¥599', '¥469', '22%', '¥80', '高端品质'], ['本品', '待定', '待定', '-', '-', '差异化']] }] },
      { title: '定价策略建议', role: 'operations', content: [{ title: '策略方向', type: 'list', items: ['甜点定价：找到竞品价格空隙，避免直接价格战', '赠品锚定：用高感知赠品拉高价值感而非降价', '满减组合：设计跨品类满减套餐提升客单价', '限时策略：前N件优惠+整点秒杀刺激下单'] }] },
    ],
    createdAt: '2026-06-05', tags: ['定价', '竞品分析', '价格策略', '618'],
    feedback: 'v1.0 刚上线，建议下版本增加各平台满减规则自动计算功能。',
    versionHistory: [
      { version: 'v1.0', date: '2026-06-05', changes: '初始版本：竞品价格带矩阵+定价策略框架。' },
    ],
    reuseCount: 2, rating: 4.4,
  },
]

// ─── Report Summaries (per project) ────────────────────────

export const reportSummaries: Record<string, string[]> = {
  p1: [
    '用户对风力和干发速度最敏感：三个竞品的高频好评均围绕「风速快、干发快」，差评集中在噪音、发热和做工——这三项是当前品类最大的差异化机会。',
    '噪音是最大共性痛点：62条高频评论提到噪音偏大或声音尖锐，覆盖全部3个竞品。低噪音风道技术是可量化且极具传播力的核心卖点。',
    '详情页信息层级需要重排：所有竞品详情页将技术参数放在第三屏之后，但用户评论显示「静音」「恒温」「售后」才是决策关键信息。',
  ],
  p2: [
    '避障能力是扫地机器人的第一决策因素：科沃斯 X2 的避障误判、石头 G20 的地图丢失、追觅 X30 Pro 的噪音问题是三大品牌各自的致命弱点。',
    '地板保护和耗材成本是复购关键：石头 G20 划伤实木地板、科沃斯 X2 耗材成本高的反馈频率高，这两个痛点直接影响用户的长期使用信心。',
    '三品牌各有明显短板：没有任何一款产品能同时满足「精准避障 + 不伤地板 + 静音 + 低耗材成本」，这为差异化竞争提供了明确方向。',
  ],
  p3: [
    '安全焦虑是母婴用户的第一决策因素：材质安全认证、致敏原检测和医护级标准的展示直接影响转化率，Babycare 凭借医护认证优势领先。',
    '尺寸和舒适度是复购核心：Babycare 和好奇都被反馈尺寸偏小，全棉时代掉絮问题突出，用户对「合适度」的敏感度远高于价格。',
    '品牌公众号内容种草效率高于短视频 2.3 倍：母婴用户更信任深度内容而非短暂曝光，全棉时代的内容策略值得参考。',
  ],
}

export const reportNextSteps: Record<string, string[]> = {
  p1: [
    '商品岗确认产品能力：能否实现低噪音风道和智能恒温控制',
    '文案岗优化首屏标题：突出「静音速干」双卖点',
    '客服岗补充售后话术：重点是退换货和保修流程',
    '设计岗重排详情页模块：静音→恒温→质感→售后',
    '运营岗确认 618 主推策略和定价方案',
  ],
  p2: [
    '商品岗确认产品能力：AI 视觉避障精度 + 柔性滚刷方案',
    '文案岗制作横向对比页面：三品牌避障/噪音/耗材实测数据',
    '运营岗确认竞品攻击策略：对标记科沃斯避障、石头地板、追觅噪音',
    '设计岗优化详情页技术模块：重点展示避障传感器和滚刷材质',
    '客服岗准备竞品对比应答话术：避障、耗材、噪音三类高频问题',
  ],
  p3: [
    '商品岗整理安全认证文件：医护级认证、皮肤刺激性测试报告',
    '文案岗优化信任内容：公众号深度种草文章 + 评论区真实用户反馈',
    '客服岗建立敏感肌/过敏体质应答模板：安全第一，退换无忧',
    '运营岗规划试用装策略：分龄尺码推荐 + 试用装引导复购',
    '设计岗在详情页首屏展示安全认证标识与真实用户好评',
  ],
}
